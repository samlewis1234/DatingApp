...
const std::string MEMBERS_FILE    = "/Users/samlewis/Desktop/cs32/project4/project4/members.txt";
const std::string TRANSLATOR_FILE = "/Users/samlewis/Desktop/cs32/project4/project4/translator.txt";

bool findMatches(const MemberDatabase& mdb, const AttributeTranslator& at);

int main() {
    MemberDatabase mdb; //success
